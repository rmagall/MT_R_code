...
metabolite_columns <- c("1X00001315",
                        "X1258", "X1024", 
                        "X1143","X100003397")
# Renaming columns
metabolites_df <- metabolites_df %>%
  rename('p-cresol sulfate' = 'X100001315',
         'anthranilate' = 'X1258', 'pantothenate'='X1024', 
        'butyrate' = 'X1143',
          'trimethylamine N-oxide' = 'X100003397')

#columns with new names
metabolite_columns_new <- c('p-cresol sulfate',
                            'anthranilate', 'pantothenate',
                            'butyrate',
...
# Convert the results to a data frame and sort by correlation values
